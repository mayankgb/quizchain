    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Link href={"/waitlist"} className="hidden md:block px-6 py-2 bg-purple-700 text-white font-medium rounded-full hover:bg-purple-800 transition-colors">
            Join waitlist
          </Link>
        </div>
        ...
        {isMenuOpen && (
          <nav className="md:hidden p-4 bg-white border-t border-gray-100">
            <div className="flex flex-col space-y-4">
              ...
              <a href="#marketing" className="font-medium hover:text-purple-700 transition-colors">For Businesses</a>
              <a href="#faq" className="font-medium hover:text-purple-700 transition-colors">FAQ</a>
              <Link href={"/waitlist"} className="px-6 py-2 bg-purple-700 text-white font-medium rounded-full hover:bg-purple-800 transition-colors">
                Join Waitlist
              </Link>
            </div>
          </nav>
      ...
      <section className="bg-[#FAF7FF] py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Quiz. Win. Earn <span className="text-purple-700">Instantly</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link href={"/waitlist"} className="px-8 cursor-pointer py-3 bg-purple-700 text-white font-medium rounded-full hover:bg-purple-800 transition-colors">
              Join Waitlist
            </Link >
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link href={"/waitlist"} className="px-8 py-3 bg-[#E3E0F3] text-purple-700 font-medium rounded-full hover:bg-purple-100 transition-colors">
                Join waitlist
              </Link>
            </div>
            <div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://x.com/mayk03jun" className="text-white hover:text-purple-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/mayank_03jun/" className="text-white hover:text-purple-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.linkedin.com/in/mayank-agrawal-b3a312299/" className="text-white hover:text-purple-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-purple-400">Join a Quiz</a></li>
                <li><a href="#" className="hover:text-purple-400">Connect Wallet</a></li>
                <li><a href="#" className="hover:text-purple-400">Create Account</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-purple-400">Create Quiz</a></li>
                <li><a href="#" className="hover:text-purple-400">Brand Solutions</a></li>
                <li><a href="#" className="hover:text-purple-400">Analytics</a></li>
                <li><a href="#" className="hover:text-purple-400">Marketing Guide</a></li>
              </ul>
            </div>
            <div>
