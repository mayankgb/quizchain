...
export namespace Prisma {
  ...
  */
  ...
  export type WaitlistOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "applyDate", ExtArgs["result"]["waitlist"]>
  ...
  interface WaitlistFieldRefs {
    ...
    readonly applyDate: FieldRef<"Waitlist", 'DateTime'>
  }
  ...
  export type WaitlistWhereInput = {
    ...
    applyDate?: DateTimeFilter<"Waitlist"> | Date | string
  }
  ...
  export type WaitlistScalarWhereWithAggregatesInput = {
    ...
    applyDate?: DateTimeWithAggregatesFilter<"Waitlist"> | Date | string
  }
